...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--ins_edge', action='store_true', help='instance map is already edge map')
        parser.add_argument('--cg_nc', type=int, default=3, help='# color guidance channel number')
