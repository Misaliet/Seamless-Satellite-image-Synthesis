...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--balance_loss', action='store_true', help='if specified, balance the loss for z1~z3')
        ...
        parser.add_argument('--more_samples', action='store_true', help='if specified, let discriminator see two more samples')
        parser.add_argument('--gradient_dloss', action='store_true', help='if specified, use discriminator loss to distinguish seams/nonseams')
