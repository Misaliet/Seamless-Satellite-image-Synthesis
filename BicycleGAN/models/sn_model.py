...
class SNModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        mask_path = opt.dataroot + '/mask/T.png'
        self.loss_mask = Image.open(mask_path)
        transform_params = get_params(self.opt, self.loss_mask.size)
        ...
        c_path = opt.dataroot + '/mask/c.png'
        ...
        w_path = opt.dataroot + '/mask/white.png'
        ...
        tfg1_path = opt.dataroot + '/mask/TfG1.png'
